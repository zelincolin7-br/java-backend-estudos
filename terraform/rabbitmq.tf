...
# Conecta eventos de criacao de pedido à fila do estoque
...
# Conecta eventos de criacao de pedido à fila de pagamentos
...
# Conecta todos os eventos de status da ordem à fila de notificacoes
